							...
							<form action="" method="post">
								...
								<tr>
									...
									<td>
										...
										<input type="checkbox" name="tempat_wisata[]" value="Bromo">Bromo<br>
										<input type="checkbox" name="tempat_wisata[]" value="Raja Ampat">Raja Ampat<br>
										<input type="checkbox" name="tempat_wisata[]" value="Semeru">Semeru<br>
									</td>
								</tr>
								<tr>
									<td>Tanggal Lahir</td>
