		...
		<div class="row justify-content-center">
			<div class="col-md-12" style="margin: 10px 0 0 0">
				<nav class="navbar navbar-expand-lg navbar-light bg-primary">
				  <a class="navbar-brand" href="#">6701174075</a>
							...
							<form action="" method="post">
								...
								<tr>
									...
									<td>
										...
										<input type="checkbox" name="genre[]" value="Thriller" <?php in_array('Thriller', $checkfilm) ? print "checked" : ""; ?>>Thriller<br>
										<input type="checkbox" name="genre[]" value="Sci-Fi" <?php in_array('Sci-Fi', $checkfilm) ? print "checked" : ""; ?>>Sci-Fi<br>
										<input type="checkbox" name="genre[]" value="Fantasy" <?php in_array('Fantasy', $checkfilm) ? print "checked" : ""; ?>>Fantasy<br>
									</td>
								</tr>
								<tr>
									<td>Tempat Wisata</td>
									...
									<td>
										...
										<input type="checkbox" name="Tempat_wisata[]" value="Bromo" <?php in_array('Bromo', $checkwisata) ? print "checked" : ""; ?>>Bromo<br>
										<input type="checkbox" name="tempat_wisata[]" value="Raja Ampat" <?php in_array('Raja Ampat', $checkwisata) ? print "checked" : ""; ?>>Raja Ampat<br>
										<input type="checkbox" name="tempat_wisata[]" value="Semeru" <?php in_array('Semeru', $checkwisata) ? print "checked" : ""; ?>>Semeru<br>
									</td>
								</tr>
								<tr>
									<td>Tanggal Lahir</td>
